#' Optimize a policy for pulling or putting, whilst keeping pulling or putting
#' on a fixed level.
#' @param num_generations number of generations
#' @param target_frequency frequency to aim for
#' @param K carrying capacity
#' @param optimize_pull Optimized when set to 1, otherwise the value will be
#' used as amount pulled per generation (if put is optimized).
#' @param optimize_put Optimized when set to 1, otherwise the value will be
#' used as amount put per generation (if pull is optimized).
...
#' @return tibble
#' @export
optimize_policy_fixed <- function(num_generations = 20,
