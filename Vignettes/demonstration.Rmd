...
```{r simulate}
sim_pop <- simRestore::simulate_policy(initial_population_size = 100,
                                       num_generations = 20,
                                       starting_freq = 0.2,
                                       K = 400)
```
...
opt_res <- simRestore::optimize_adaptive(target_frequency = 0.99,
                                       optimize_put = 1000,
                                       num_generations = 20,
                                       starting_freq = 0.2,
                                       initial_population_size = 100)
...
opt_res$curve %>%
  gather(key = "type", value = "amount", -t) %>%
...
sim_pop2 <- simRestore::simulate_policy(initial_population_size = 100,
                                       num_generations = 50,
                                       put = 10,
                                       starting_freq = 0.2,
